...
func RecordInsert(c *gin.Context, MsgData UserRecord) error {
	...
	_, err = tx.Exec(context.Background(), `INSERT INTO public."MsgRecord" ("UserID", "UserPhoto",  "UserName", "Message","MessageType","IPAddress", "Time") VALUES($1,$2,$3,$4,$5,$6,$7)`, MsgData.UserID, MsgData.PictureURL, MsgData.UserName, MsgData.Message, MsgData.MessageType, c.ClientIP(), time.Now().Format("2006-01-02 15:04:05"))
	if err != nil {
		return err
	}
